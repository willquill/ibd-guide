...
- [**Crohn's Disease**](/types/crohns-disease): This condition involves inflammation and swelling in the digestive tract, which can affect any part from the mouth to the anus. The inflammation often occurs in patches, with healthy sections of the digestive tract in between affected areas.

- [**Ulcerative Colitis**](/types/ulcerative-colitis): This type of IBD involves inflammation and sores (ulcers) along the lining of the large intestine (colon) and rectum. The inflammation is typically continuous, without healthy sections in between.
